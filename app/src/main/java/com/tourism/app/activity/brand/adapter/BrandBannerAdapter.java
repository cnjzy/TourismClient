 ...
 * 
 */
public class BrandBannerAdapter extends PagerAdapter {
	/**
	 * 上下文
	 */
	...
	public BrandBannerAdapter(Context mContext, List<NewsVO> mDataList, ChildViewPager mViewPager, PointWidget pw) {
