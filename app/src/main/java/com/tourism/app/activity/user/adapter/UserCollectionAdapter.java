 ...
 * todo 用户收藏适配器
 */
public class UserCollectionAdapter extends ETSBaseAdapter {
    public DisplayImageOptions bgOptions;

    public UserCollectionAdapter(BaseActivity context, AbsListView listView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UserCollectionVO vo = (UserCollectionVO) getItem(position);
